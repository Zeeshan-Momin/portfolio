  ...
  return (
    <section id="education" className="py-24 bg-gradient-to-b from-purple-900/5 to-transparent">
      <div className="max-w-7xl mx-auto px-6">
        <div className="space-y-4 mb-16 overflow-visible animate-fade-up">
        ...
        <div className="relative">
          {/* Timeline line */}
          <div className="absolute left-0 md:left-1/2 w-1 h-full bg-gradient-to-b from-cyan-400/50 to-purple-600/20 transform md:-translate-x-1/2 animate-fade"></div>
            ...
            {items.map((item, i) => (
              <div key={i} className={`md:flex gap-12 items-start animate-fade-up transition-smooth ${i % 2 === 0 ? 'md:flex-row-reverse' : ''}`} style={{animationDelay: `${i * 0.1}s`}}>
                ...
                <div className="md:w-1/2 ml-12 md:ml-0">
                  <div className="neon-glow p-6 rounded-2xl bg-gradient-to-br from-white/5 to-white/2 border border-white/10 hover:border-cyan-400/50 transition-all-smooth hover-lift hover-glow">
