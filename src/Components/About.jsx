    ...
    <section id="about" className="py-24 bg-gradient-to-b from-transparent to-purple-900/5">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <p className="text-gray-300 text-lg leading-relaxed md:col-span-2 animate-fade-up stagger-1">
          ...
          <div className="neon-glow p-6 rounded-2xl bg-white/5 border border-white/10 text-center animate-fade-up stagger-2 hover-lift transition-smooth">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="neon-glow p-8 rounded-2xl bg-gradient-to-br from-white/5 to-white/2 border border-white/10 hover:border-cyan-400/50 transition-smooth hover-lift animate-fade-up stagger-1">
          ...
          <div className="neon-glow p-8 rounded-2xl bg-gradient-to-br from-white/5 to-white/2 border border-white/10 hover:border-cyan-400/50 transition-smooth hover-lift animate-fade-up stagger-2">
          ...
          <div className="neon-glow p-8 rounded-2xl bg-gradient-to-br from-white/5 to-white/2 border border-white/10 hover:border-cyan-400/50 transition-smooth hover-lift animate-fade-up stagger-3">
